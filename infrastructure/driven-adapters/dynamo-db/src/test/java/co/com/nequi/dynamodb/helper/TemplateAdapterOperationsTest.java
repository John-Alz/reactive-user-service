...
import co.com.nequi.dynamodb.UserNoSqlEntity;
...
class TemplateAdapterOperationsTest {
    ...
    @Mock
    private DynamoDbAsyncTable<UserNoSqlEntity> customerTable;

    private UserNoSqlEntity modelEntity;

//    @BeforeEach
//    void setUp() {
//        MockitoAnnotations.openMocks(this);
//
//        when(dynamoDbEnhancedAsyncClient.table("table_name", TableSchema.fromBean(UserNoSqlEntity.class)))
//                .thenReturn(customerTable);
//
//        modelEntity = new UserNoSqlEntity();
...
//        UserNoSqlEntity modelEntityUnderTest = new UserNoSqlEntity("id", "atr1");
//
...
//    }
    ...
    void testSave() {
        ...
        when(mapper.map(modelEntity, UserNoSqlEntity.class)).thenReturn(modelEntity);
